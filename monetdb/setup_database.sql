...
CREATE TABLE part  ( p_partkey     CHAR(10) NOT NULL,
...
CREATE TABLE supplier ( s_suppkey     CHAR(10) NOT NULL,
...
CREATE TABLE partsupp ( ps_partkey     CHAR(10) NOT NULL,
                        ps_suppkey     CHAR(10) NOT NULL,
                        ps_availqty    INTEGER NOT NULL,
                        ps_supplycost  DECIMAL(15,2)  NOT NULL,
                        ps_comment     VARCHAR(199) NOT NULL );

CREATE TABLE customer ( c_custkey     CHAR(10) NOT NULL,
...
CREATE TABLE orders  ( o_orderkey       CHAR(10) NOT NULL,
                       o_custkey        CHAR(10) NOT NULL,
...
CREATE TABLE lineitem ( l_orderkey    CHAR(10) NOT NULL,
                        l_partkey     CHAR(10) NOT NULL,
                        l_suppkey     CHAR(10) NOT NULL,

...
CREATE TABLE nation  ( n_nationkey  CHAR(2) NOT NULL,
                       n_name       CHAR(25) NOT NULL,
                       n_regionkey  CHAR(1) NOT NULL,
                       n_comment    VARCHAR(152));

CREATE TABLE region  ( r_regionkey  CHAR(1) NOT NULL,
                       r_name       CHAR(25) NOT NULL,
                       r_comment    VARCHAR(152));

CREATE TABLE part  ( p_partkey     CHAR(100) NOT NULL,
...
CREATE TABLE supplier ( s_suppkey     CHAR(100) NOT NULL,
...
CREATE TABLE partsupp ( ps_partkey     CHAR(100) NOT NULL,
                        ps_suppkey     CHAR(100) NOT NULL,
                        ps_availqty    INTEGER NOT NULL,
                        ps_supplycost  DECIMAL(15,2)  NOT NULL,
                        ps_comment     VARCHAR(199) NOT NULL );

CREATE TABLE customer ( c_custkey     CHAR(100) NOT NULL,
...
CREATE TABLE orders  ( o_orderkey       CHAR(100) NOT NULL,
...
CREATE TABLE lineitem ( l_orderkey    CHAR(100) NOT NULL,
                        l_partkey     CHAR(100) NOT NULL,
                        l_suppkey     CHAR(100) NOT NULL,

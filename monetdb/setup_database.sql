...
CREATE TABLE part  ( p_partkey     VARCHAR(10) NOT NULL,
...
CREATE TABLE supplier ( s_suppkey     VARCHAR(10) NOT NULL,
...
CREATE TABLE partsupp ( ps_partkey     VARCHAR(10) NOT NULL,
                        ps_suppkey     VARCHAR(10) NOT NULL,
                        ps_availqty    INTEGER NOT NULL,
                        ps_supplycost  DECIMAL(15,2)  NOT NULL,
                        ps_comment     VARCHAR(199) NOT NULL );

CREATE TABLE customer ( c_custkey     VARCHAR(10) NOT NULL,
...
CREATE TABLE orders  ( o_orderkey       VARCHAR(10) NOT NULL,
...
CREATE TABLE lineitem ( l_orderkey    VARCHAR(10) NOT NULL,

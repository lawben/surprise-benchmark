...
(
    ...
    S_NATIONKEY CHAR(2) NOT NULL, -- references N_NATIONKEY
    S_PHONE     CHAR(15),
    S_ACCTBAL   DECIMAL,
...
(
    PS_PARTKEY    VARCHAR(10) NOT NULL, -- references P_PARTKEY
    PS_SUPPKEY    VARCHAR(10) NOT NULL, -- references S_SUPPKEY
    PS_AVAILQTY   INTEGER,
...
(
    ...
    C_NATIONKEY  CHAR(2) NOT NULL, -- references N_NATIONKEY
    C_PHONE      CHAR(15),
    C_ACCTBAL    DECIMAL,
...
CREATE TABLE ORDERS
(
    O_ORDERKEY      VARCHAR(10),
    O_CUSTKEY       VARCHAR(10) NOT NULL, -- references C_CUSTKEY
...
(
    L_ORDERKEY      VARCHAR(10) NOT NULL, -- references O_ORDERKEY
    L_PARTKEY       VARCHAR(10) NOT NULL, -- references P_PARTKEY (compound fk to PARTSUPP)
    L_SUPPKEY       VARCHAR(10) NOT NULL, -- references S_SUPPKEY (compound fk to PARTSUPP)
...
(
    N_NATIONKEY CHAR(2),
    N_NAME      CHAR(25),
    N_REGIONKEY CHAR(1) NOT NULL, -- references R_REGIONKEY

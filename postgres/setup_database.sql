...
(
    PS_PARTKEY    CHAR(10) NOT NULL, -- references P_PARTKEY
    PS_SUPPKEY    CHAR(10) NOT NULL, -- references S_SUPPKEY
    PS_AVAILQTY   INTEGER,
...
(
    O_ORDERKEY      CHAR(10),
    O_CUSTKEY       CHAR(10) NOT NULL, -- references C_CUSTKEY
...
(
    L_ORDERKEY      CHAR(10) NOT NULL, -- references O_ORDERKEY
    L_PARTKEY       CHAR(10) NOT NULL, -- references P_PARTKEY (compound fk to PARTSUPP)
    L_SUPPKEY       CHAR(10) NOT NULL, -- references S_SUPPKEY (compound fk to PARTSUPP)
